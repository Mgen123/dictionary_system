...
Partial Public Class dictionaryDataSet
    ...
    Partial Public Class usersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddusersRow(ByVal Name As String, ByVal EmailAddress As String, ByVal UserName As String, ByVal UserPassword As Integer) As usersRow
            Dim rowusersRow As usersRow = CType(Me.NewRow,usersRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Name, EmailAddress, UserName, UserPassword}
        ...
        Private Sub InitClass()
            ...
            Me.columnUserPassword = New Global.System.Data.DataColumn("UserPassword", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
    ...
    Partial Public Class usersRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Property UserPassword() As Integer
            Get
                Try 
                    Return CType(Me(Me.tableusers.UserPasswordColumn),Integer)
                Catch e As Global.System.InvalidCastException
...
Namespace dictionaryDataSetTableAdapters
    ...
    Partial Public Class usersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `users` WHERE ((`ID` = ?) AND ((? = 1 AND `UserPassword` IS NULL) OR "& _ 
                "(`UserPassword` = ?)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_UserPassword", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "UserPassword", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._adapter.InsertCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `users` (`Name`, `EmailAddress`, `UserName`, `UserPassword`) VALUES ("& _ 
                "?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("UserPassword", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "UserPassword", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.UpdateCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `users` SET `Name` = ?, `EmailAddress` = ?, `UserName` = ?, `UserPassword`"& _ 
                " = ? WHERE ((`ID` = ?) AND ((? = 1 AND `UserPassword` IS NULL) OR (`UserPassword"& _ 
                "` = ?)))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("UserPassword", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "UserPassword", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_UserPassword", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "UserPassword", Global.System.Data.DataRowVersion.Original, false, Nothing))
        End Sub
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.gen.My.MySettings.Default.dictionaryConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Name, EmailAddress, UserName, UserPassword FROM users"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As dictionaryDataSet.usersDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As dictionaryDataSet.usersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As dictionaryDataSet.usersDataTable = New dictionaryDataSet.usersDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As dictionaryDataSet.usersDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_UserPassword As Global.System.Nullable(Of Integer)) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_ID,Integer)
            If (Original_UserPassword.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(1).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(2).Value = CType(Original_UserPassword.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal EmailAddress As String, ByVal UserName As String, ByVal UserPassword As Global.System.Nullable(Of Integer)) As Integer
            ...
            End If
            If (UserPassword.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(3).Value = CType(UserPassword.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal EmailAddress As String, ByVal UserName As String, ByVal UserPassword As Global.System.Nullable(Of Integer), ByVal Original_ID As Integer, ByVal Original_UserPassword As Global.System.Nullable(Of Integer)) As Integer
            If (Name Is Nothing) Then
            ...
            End If
            If (UserPassword.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(3).Value = CType(UserPassword.Value,Integer)
            Else
            ...
            If (Original_UserPassword.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_UserPassword.Value,Integer)
            Else
